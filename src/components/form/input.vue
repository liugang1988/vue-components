...
<style lang="less">
    ...
    .ui-input-wrap .ui-input:focus,.ui-input-wrap .ui-input:hover {
        border-color: #5cadff
    }

    .ui-input-wrap .ui-input::-webkit-input-placeholder {
        color: #c3cbd6
    }
    ...
    .ui-input-wrap .ui-icon:before{
       vertical-align: sub;
       display: inline-block;
    }

    .ui-input-wrap .ui-icon+.ui-input {
        padding-right: 35px;
    }
